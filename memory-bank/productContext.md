...
- Akıllı Header + hamburger menü (mobil)
- Hero bölümü (öne çıkan slogan + arama çubuğu)
- Duyuru/Haber bandı (sol sütun / kayan bant)
- Sıkça Sorulan Sorular bölümü
- Kulüp başvuru formu (ya da yönlendirme sayfası)
- Footer

### 🟡 Aşama 2 — Arama & Listeleme

- Branş ve şehir bazlı filtreleme
- Kulüp liste sayfası (kart tasarımı)
- Kulüp detay sayfası (profil, harita iframe, iletişim)
- Temel SEO meta tagleri (her sayfa için)
